...
const Home: NextPage = () => {
  return (
    <>
      ...
      <main className="relative bg-02 flex h-[100svh] items-center justify-center overflow-y-auto overflow-x-hidden bg-black">
        <div
        ...
        <div
          ...
          blur-[130px]"
        />
        <div className="relative z-20  mt-14 flex w-full sm:max-w-[520px] flex-col items-center bg-white px-4 py-8 pt-20 sm:w-fit sm:rounded-xl sm:border sm:px-5 sm:py-8 sm:pt-20">
          ...
          <div className="mb-4 flex flex-col items-center">
            ...
            <h2 className="mb-4 text-neutral-700 font-semibold">assistência técnica</h2>
            <p className="text-sm text-neutral-900">
              Faço consertos e vendas de celular na região de Canudos/NH, para fazer um orçamento, entre em contato 👇
            </p>
          </div>
